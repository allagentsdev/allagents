...
checkout already matches its remote is reported as skipped and is neither
re-applied nor re-synchronized. Internal client synchronization does not
introduce a separate status phase.
